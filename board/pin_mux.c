...
- {pin_num: K13, pin_signal: GPIO_AD_20, label: 'SAI1_RXD[0]/J9[7]/J50[20]/J61[1]/BT_PCM_RXD/U16[10]/U355[18]', identifier: LPSPI1_PCS3}
...
- pin_list:
  ...
  - {pin_num: K13, peripheral: LPSPI1, signal: PCS3, pin_signal: GPIO_AD_20, pull_up_down_config: Pull_Up, pull_keeper_select: Keeper, slew_rate: Slow}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_20_LPSPI1_PCS3,          /* GPIO_AD_20 is configured as LPSPI1_PCS3 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
  ...
  IOMUXC_SetPinConfig(
      ...
      0x0BU);                                 /* Slew Rate Field: Fast Slew Rate
                                                 ...
                                                 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_20_LPSPI1_PCS3,          /* GPIO_AD_20 PAD functional properties : */
      0x0BU);                                 /* Slew Rate Field: Fast Slew Rate
                                                 Drive Strength Field: high drive strength
                                                 Pull / Keep Select Field: Pull Disable, Highz
                                                 Pull Up / Down Config. Field: Weak pull up
