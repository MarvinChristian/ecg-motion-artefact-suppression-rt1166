...
app.bpfDrop = uidropdown(left, ...
    'Items', { ...
        ...
        'B8  Butter 12th  0.5-40 Hz'}, ...
    'Value', 'B8  Butter 12th  0.5-40 Hz', ...
    'BackgroundColor', C_DROP, 'FontColor', C_FG);
...
app.notchDrop = uidropdown(left, ...
    'Items', { ...
        ...
        'N2  NLMS  u=0.005  50 Hz fixed', ...
        'N3  IIR + NLMS  50 Hz hybrid', ...
        'N4  RLS  L=0.99  50 Hz fixed', ...
        'N5  IIR + RLS  50 Hz hybrid', ...
        'N6  Auto-detect line/noise'}, ...
    'Value', 'N6  Auto-detect line/noise', ...
    'BackgroundColor', C_DROP, 'FontColor', C_FG);
