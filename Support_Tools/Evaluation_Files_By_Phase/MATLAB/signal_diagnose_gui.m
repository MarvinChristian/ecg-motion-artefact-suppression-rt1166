...
%
%   Consolidates the phase3_diagnose, phase3_diagnose_advanced,
%   phase3_mas_ceiling, and Python mas_coherence_audit workflows.
%
...
lead_dd = uidropdown(lay,'Items',{'CH1 (ADS / AD8233)','CH2 (ADS only)'}, ...
