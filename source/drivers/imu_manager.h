 ...
 *        IMU 0 — CS0: J10 pin 3 (D10) — LPSPI1 PCS0 — Left Arm  (LA)
 *        IMU 1 — CS1: J9  pin 5 (D4)  — LPSPI1 PCS1 — Right Arm (RA)
 *        IMU 2 — CS2: J9  pin 1 (D0)  — LPSPI1 PCS2 — Right Leg (RL)
 *
 ...
 *   This is the correct interface for Phase 1 data collection, which must
 *   preserve the full motion artefact spectrum up to the hardware cutoff
 *   for Phase 3 MAS algorithm evaluation. The Kalman filter's ~11 Hz
 ...
 *   (Partridge 2016/2021; Gao 2026; Kosek 2021), which contributes to
 *   potential reference signals for the gyroscope-augmented MAS algorithms
 *   M9–M13 (Beach et al., Healthcare Technol. Lett., 2021, PMC8450177;
 *   Ma et al., Rev. Sci. Instrum., 2024).
 *
 * REFERENCES:
